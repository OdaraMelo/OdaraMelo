# Base de Conhecimento — NoteLagos Service (consolidada)

> Fonte: base oficial em TXT + atualizações da Odara + perfis públicos (Instagram, Google, WhatsApp Business), 19/09/2026.
> Itens marcados **(confirmar)** dependem de verificação antes de uso em texto público.

## Identidade
- **Nome:** NoteLagos Service
...
- Posicionamento: 100% do que pode ser reformado no computador, ele reforma.

## Laboratório / instrumentação
- Microscópio Trinocular, Osciloscópio Digital, Fontes de Precisão, Estações de Solda Profissionais.
- Estação de retrabalho / hot air **(confirmar marca e modelo — Odara citou "Honton")**.
- Laboratório climatizado.

## Garantia
- Reparo em placa: **3 meses (90 dias)** sobre o serviço.
- Perde a garantia se o equipamento for aberto/manuseado por outro técnico após o reparo.
- Usados: sem garantia, mas revisados e entregues como novos.
- Peças trazidas pelo cliente / de terceiros: garantia é do fabricante/vendedor, não da NoteLagos.

## Alertas (Cabo Frio)
- Preventiva recomendada a cada 6 meses por causa da maresia.
- Riscos biológicos: ninhos de insetos, pelos de cão (superaquecimento), xixi de gato (ácido, destrói placa).
- Líquido na placa: trazer imediatamente para banho químico.

## Pagamento e O.S.
- Dinheiro, PIX ou cartões (parcelado em até 12x com juros do cartão).
- Toda ordem de serviço vira recibo digital enviado no WhatsApp.
